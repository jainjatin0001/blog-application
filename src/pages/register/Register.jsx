...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();         // to prevent the refreshing of page when submit button is clicked
    setError(false)
    try {
  ...
  return (
    <div className="register">
      ...
      <form className="registerForm" onSubmit={handleSubmit} >
        ...
        <label >Email</label>
        <input type="text" className="registerInput" placeholder="Enter email" onChange={e => setEmail(e.target.value)} />
      ...
      { error && <span className="xyz">Something went wrong!</span>}
    </div>
  )
}
